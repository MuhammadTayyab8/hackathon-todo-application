...
# Automated deployment script for Todo App to Docker Desktop Kubernetes
...
if ! kubectl cluster-info | grep -q "kubernetes.docker.internal"; then
...
echo "✓ kubectl connected to Docker Desktop cluster"
echo ""
...
echo "✓ Images available to Kubernetes"
echo ""
